...
| `australia-gnss-stations-2024.parquet` | 2 | _see header of `scripts/samples/australia_gnss_stations_2024.py`_ |
| `australia-gnss-stations.parquet` | 2 | _see header of `scripts/samples/australia_gnss_stations.py`_ |
...
| `gps-trajectory-xyzm.parquet` | 12 | _see header of `scripts/samples/gps_trajectory_xyzm.py`_ |
